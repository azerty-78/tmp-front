...
/**
 * Layout pour le module Employé
 */
export const EmployeLayout = ({ children }: EmployeLayoutProps) => {
  ...
  const navItems = [
    { path: '/employe/dashboard', label: 'Tableau de bord', icon: FaHome },
    { path: '/employe/content', label: 'Gestion du contenu', icon: FaFileAlt },
  ];
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-6 border-b border-gray-700">
        ...
        <p className="text-white text-sm text-center mt-2">
          {themeConfig.modules.employe.name}
        </p>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              style={
                isActive
                  ? { backgroundColor: themeConfig.modules.employe.color }
                  : undefined
              }
            >
              <Icon />
